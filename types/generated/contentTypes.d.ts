...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Enumeration<['Cash', 'G cash', 'Card']>;
    payment_date: Schema.Attribute.Date;
    payment_name: Schema.Attribute.Enumeration<
      [
        'Enrollment Fee',
        'LT-Prelims',
        'Prelims',
    ...
    >;
    payment_type: Schema.Attribute.Enumeration<['Tuition', 'Misc', 'Others']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    report_type: Schema.Attribute.Enumeration<
      ['payment_summary', 'student_financial_report']
    >;
    student: Schema.Attribute.Relation<'manyToOne', 'api::student.student'>;
    summary: Schema.Attribute.Text;
    title: Schema.Attribute.String;
    total_amount_paid: Schema.Attribute.Decimal;
    total_payments: Schema.Attribute.BigInteger;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    student_id: Schema.Attribute.Text;
